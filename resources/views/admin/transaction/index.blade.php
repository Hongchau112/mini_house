                ...
                <div class="card-inner p-0">
                    <table class="table table-tranx" id="list">
                        ...
                        <tr class="nk-tb-item nk-tb-head">
                            <th class="nk-tb-col"><span class="">ID Phòng</span></th>
                            <th class="tb-tnx-info">
                                                            <span class="tb-tnx-desc d-none d-sm-inline-block">
                                                                <span>ID người đặt</span>
                                                            </span></th>
                            <th><span class="tb-tnx-date">Ngày đặt</span></th>


                            <th class="tb-tnx-id"><span class="">Trạng thái</span></th>
                            <th class="tb-tnx-amount is-alt">
                                <span class="tb-tnx-total">Tổng tiền</span>
                                <span class="tb-tnx-status d-none d-md-inline-block">Thanh toán</span>
                            </th>
                        </tr><!-- tb-tnx-item -->
                        </thead>
                        <tbody>
                        ...
                        <tr class="tb-tnx-item">
                            ...
                            <td >
                                @if($booking->booking_status=='new')
                                    <div class="dot dot-success d-md-none">Đơn mới</div>
                                @elseif($booking->booking_status=='pending')
                                    <div class="dot dot-info d-md-none">Đang xử lý</div>
                                @elseif($booking->booking_status=='success')
                                    <div class="dot dot-success d-md-none">Thành công</div>
                                @elseif($booking->booking_status=='cancel')
                                    <div class="dot dot-success d-md-none">Đã hủy</div>
                                @endif
                            </td>
