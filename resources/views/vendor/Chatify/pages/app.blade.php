        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($type == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> Người</a>
...
{{--                    <a target="_blank" style="color:{{$messengerColor}};" href="https://chatify.munafio.com/notes#groups-feature">Nhấp vào đây</a>để biết thêm chi tiết!--}}
                </p>
             </div>
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Soạn để tìm kiếm</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">Không truy cập được internet</span>
        </div>
        {{-- Messaging area --}}
